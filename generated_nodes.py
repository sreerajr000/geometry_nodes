...
def compare_int(a=0, b=0, epsilon=)

def compare(a=0.0, b=0.0, a=0.0, b=0.0, a=0.0, b=0.0, a=0.0, b=0.0, a=0.0, b=0.0, c=0.8999999761581421, angle=0.08726649731397629, epsilon=0.0010000000474974513, operation='GREATER_THAN', mode='ELEMENT', data_type='FLOAT'):
...
def input_vector(, vector=<Vector (0.0000, 0.0000, 0.0000)>):
    node = ng.nodes.new("FunctionNodeInputVector")
    node.vector = vector

def random_value(min=[0.0, 0.0, 0.0], max=[1.0, 1.0, 1.0], min=[0.0, 0.0, 0.0], max=[1.0, 1.0, 1.0], min=[0.0, 0.0, 0.0], max=[1.0, 1.0, 1.0], probability=0.5, id=None, seed=None, data_type='FLOAT'):
...
def accumulate_field(value=[1.0, 1.0, 1.0], value=[1.0, 1.0, 1.0], value=[1.0, 1.0, 1.0], group_id=None, domain='POINT', data_type='FLOAT'):
...
def attribute_statistic(geometry=None, selection=None, attribute=0.0, attribute=0.0, domain='POINT', data_type='FLOAT'):
...
def blur_attribute(value=0.0, value=0.0, value=0.0, value=0.0, iterations=None, weight=1.0, data_type='FLOAT'):
...
def capture_attribute(geometry=None, value=[0.0, 0.0, 0.0], value=[0.0, 0.0, 0.0], value=[0.0, 0.0, 0.0], value=[0.0, 0.0, 0.0], value=[0.0, 0.0, 0.0], domain='POINT', data_type='FLOAT'):
...
def group_output(geometry=None, =None, is_active_output=True):
    node = ng.nodes.new("NodeGroupOutput")
    if isinstance(geometry, bpy.types.NodeSocket):
        ng.links.new(node.inputs["Geometry"], geometry)
    else:
        node.inputs["Geometry"] = geometry
    if isinstance(, bpy.types.NodeSocket):
        ng.links.new(node.inputs[""], )
    else:
        node.inputs[""] = 
